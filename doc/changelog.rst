...
* Does not raise "Unknown load command" anymore, treats it as raw data instead
  like in the macholib provided by Apple on Mac OS X with Command Line Tools.

* MachO supports file buffers now - instead of juggling path names
